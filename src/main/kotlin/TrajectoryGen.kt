...
//            .forward(-10.0)
//            .splineTo(Vector2d(52.0, -29.0), Math.toRadians(0.0))
//            .build()
...
//        val builder1 = TrajectoryBuilder(startPose, startPose.heading, combinedConstraints)
//            .forward(-20.0)
//            .splineTo(Vector2d(16.0,-36.0), Math.toRadians(180.0))
//            .build()
//        val builder2 = TrajectoryBuilder(builder1.end(),builder1.end().heading, combinedConstraints)
//            .forward(-3.0)
//            .build()
...
//        val builder2 = TrajectoryBuilder(builder1.end(),builder1.end().heading, combinedConstraints)
//            .forward(-30.0)
//            .splineTo(Vector2d(52.0, -39.0), Math.toRadians(0.0))
//            .build()
...
//        val builder3 = TrajectoryBuilder(builder2.end(),builder2.end().heading, combinedConstraints)
//            .strafeLeft(12.0)
//            .splineTo(Vector2d(30.0, -15.0), Math.toRadians(0.0))
//            .splineTo(Vector2d(40.0, -39.0), Math.toRadians(-90.0))
//            .build()
//        val builder4 = TrajectoryBuilder(builder3.end(),builder3.end().heading, combinedConstraints)
//            .forward(-12.0)
//            .build()
...
//        val builder1 = TrajectoryBuilder(startPose, startPose.heading, combinedConstraints)
//            .forward(-5.0)
//            .splineTo(Vector2d(-40.0, -50.0), Math.toRadians(90.0))
//            .splineTo(Vector2d(-36.0,-33.0), Math.toRadians(-90.0))
//            .build()
//        val builder2 = TrajectoryBuilder(builder1.end(),builder1.end().heading, combinedConstraints)
//            .forward(-3.5)
//            .build()
//        val builder3 = TrajectoryBuilder(builder2.end(), builder2.end().heading, combinedConstraints)
//            .strafeRight(33.0)
//            .splineTo(Vector2d(30.0, -20.0), Math.toRadians(0.0))
...
//        val builder2 = TrajectoryBuilder(builder1.end(),builder1.end().heading, combinedConstraints)
//            .forward(-10.0)
//            .splineTo(Vector2d(52.0, 30.5), Math.toRadians(0.0))
//            .build()
